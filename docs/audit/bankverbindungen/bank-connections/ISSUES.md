...
- **#4** is unchanged and is the main open item: there is still no disconnect and no re-authorise,
  ...
  belong once the another client Hub's Edge Function is ported.
