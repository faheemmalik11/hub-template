...
const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    // Row + right-aligned + gap on every width, matching DialogFooter/AlertDialogFooter: the old
    // `flex-col-reverse` mobile default stacked the buttons with no vertical gap between them.
