...
/**
 * The header bell. Presentational and portable (see docs/NOTIFICATIONS.md): the host supplies
 * translated items, the unseen count for the badge, and a callback fired when the dropdown
 * opens, which is the moment "new" stops being new.
 */
