...
export function ZeitraumPicker({
  ...
  const [kalender, setKalender] = React.useState(false);

  const selected = options.find((o) => o.value === value) ?? null;
  const istCustom = value === customValue;
    ...
    >
      ...
      <PopoverContent
        ...
        className={cn(
          ...
          kalender ? "w-auto p-3" : "w-[var(--radix-popover-trigger-width)] min-w-[220px]",
        )}
      >
        {kalender ? (
          <DateRangeCalendar
