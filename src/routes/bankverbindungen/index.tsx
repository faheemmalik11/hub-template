...
/**
 * Moved to /bank-accounts when this template anglicised its URLs.
 *
 ...
 */
export const Route = createFileRoute("/bankverbindungen/")({
  beforeLoad: ({ search }) => {
    throw redirect({ to: "/bank-accounts", search, replace: true });
  },
});
