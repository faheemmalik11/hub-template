 ...
 */
export const Route = createFileRoute("/auswertungen/")({
...
function AuswertungenSeite() {
  ...
  const config: CostAnalysisConfig = {
    ...
    onOpenBeleg: (id) => navigate({ to: "/eingangsrechnungen/$nr", params: { nr: id } }),
    onOpenManualBooking: () => navigate({ to: "/manuelle-buchungen" }),
  };

  return <Kostenanalyse config={config} search={search} onSearchChange={onSearchChange} />;
}
