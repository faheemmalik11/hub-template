---
name: staey-theme
description: The Stäy Hub colour system — warm white surfaces, soft beige chrome, muted brown accent. Load before choosing any colour, writing a Tailwind colour class, styling a button/toggle/badge/chart, or editing src/styles.css. Explains which token to reach for, the restraint rule that keeps the palette clean, and what never to hard-code.
---
...
Both are reference values from staey.de. Do not repurpose them as UI colours.
