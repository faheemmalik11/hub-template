...
- `staey-data` — Supabase read/write conventions for the existing client-side query layer.
- `staey-i18n` — German-UI / English-code rule in full.
- `staey-gotchas` — known dead code in the auth/server-fn area (`requireSupabaseAuth` was
